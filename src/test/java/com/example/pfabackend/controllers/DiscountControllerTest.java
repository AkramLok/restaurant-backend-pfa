...
class DiscountControllerTest {
    ...
    void testGetAllDiscounts() throws Exception {
        // Arrange
        when(discountService.getAllDiscounts()).thenReturn(new ArrayList<>());
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/discount");
    ...
    /**
     * Method under test:
     * {@link DiscountController#getDiscountsByRestaurantId(Long)}
     */
    @Test
    void testGetDiscountsByRestaurantId() throws Exception {
        // Arrange
        when(discountService.getDiscountsByRestaurantId(Mockito.<Long>any())).thenReturn(new ArrayList<>());
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/discount/restaurant/{restaurantId}",
                1L);
    ...
    /**
     * Method under test: {@link DiscountController#getDiscountByProductId(Long)}
     */
    @Test
    void testGetDiscountByProductId() throws Exception {
        // Arrange
        ...
        when(discountService.getDiscountByProductId(Mockito.<Long>any())).thenReturn(discount);
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/discount/product/{productId}", 1L);
    ...
    /**
     * Method under test:
     * {@link DiscountController#createOrUpdateDiscount(Long, Discount)}
     */
    @Test
    void testCreateOrUpdateDiscount() throws Exception {
        // Arrange
        Location location = new Location();
        location.setLatitude(10.0d);
        location.setLongitude(10.0d);
        ...
        discount.setProduct(product);
        discount.setProductCollection(productCollection);
        when(discountService.createOrUpdateDiscount(Mockito.<Long>any(), Mockito.<Discount>any())).thenReturn(discount);
        ...
        String content = (new ObjectMapper()).writeValueAsString(discount2);
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/discount/product/{productId}", 1L)
        ...
        MockMvcBuilders.standaloneSetup(discountController)
                ...
                .andExpect(MockMvcResultMatchers.content().contentType("application/json"))
                .andExpect(MockMvcResultMatchers.content()
                        .string("{\"message\":\"Discount of percentage: 3 %, created successfully of the product Name\"}"));
    }

    /**
     * Method under test: {@link DiscountController#updateDiscount(Long, Discount)}
     */
    @Test
    void testUpdateDiscount() throws Exception {
        ...
        discount.setProduct(product);
        discount.setProductCollection(productCollection);
        when(discountService.updateDiscount(Mockito.<Long>any(), Mockito.<Discount>any())).thenReturn(discount);
        ...
        discount2.setProductCollection(productCollection2);
        String content = (new ObjectMapper()).writeValueAsString(discount2);
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.put("/api/discount/product/{discountId}", 1L)
                .contentType(MediaType.APPLICATION_JSON)
                .content(content);
        ...
        MockMvcBuilders.standaloneSetup(discountController)
                ...
                .andExpect(MockMvcResultMatchers.content().contentType("application/json"))
                .andExpect(MockMvcResultMatchers.content()
                        .string("{\"message\":\"Discount of percentage: 3 %, updated successfully of the product Name\"}"));
    }

    /**
     * Method under test: {@link DiscountController#deleteDiscount(Long)}
     */
    @Test
    void testDeleteDiscount() throws Exception {
        // Arrange
        doNothing().when(discountService).deleteDiscount(Mockito.<Long>any());
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/api/discount/{discountId}", 1L);

        // Act
        ResultActions actualPerformResult = MockMvcBuilders.standaloneSetup(discountController)
                .build()
                .perform(requestBuilder);
     ...
     */
    @Test
    void testDeleteDiscount2() throws Exception {
        // Arrange
        doNothing().when(discountService).deleteDiscount(Mockito.<Long>any());
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/api/discount/{discountId}", 1L);
